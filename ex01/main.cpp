...
/*   Updated: 2022/10/24 12:13:47 by mlarra           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << "*******************" << std::endl;
	// Cat hi(*kitten);
	std::cout << "1 kitten: " << kitten->getPointerBrain() << std::endl;
	std::cout << "1 deep copy: " << dolly->getPointerBrain() << std::endl;
	std::cout << "*******************" << std::endl;

	dolly->operator=(*kitten);
	...
	// std::cout << "hi copy: " << hi.getPointerBrain() << std::endl;
	std::cout << "*******************" << std::endl;
	// Animal	animal;
	// animal.makeSound();
	return 0;
